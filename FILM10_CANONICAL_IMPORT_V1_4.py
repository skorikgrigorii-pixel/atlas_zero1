...
print("=" * 120)
print("ATLAS ZERO — FILM10 CANONICAL IMPORT V1.4")
print("=" * 120)
print("ROOT       :", ROOT)
print("DATABASE   :", DB)
...
for p in paths:
    ...
    asset_id = project_asset_id(digest)
...
if len({a["id"] for a in assets}) != 60:
...
(OUT / "FILM10_CANONICAL_SHOTS_V1_4.json").write_text(
    json.dumps(shots, ensure_ascii=False, indent=2),
    encoding="utf-8",
)

(OUT / "FILM10_CANONICAL_SCENES_V1_4.json").write_text(
    json.dumps(scenes, ensure_ascii=False, indent=2),
    encoding="utf-8",
)

(OUT / "FILM10_CANONICAL_ASSETS_V1_4.json").write_text(
...
try:
    ...
    report = {
        "schema": "atlas_zero.film10_canonical_import.v1.4",
        "project_id": PROJECT_ID,
    ...
    (OUT / "FILM10_CANONICAL_IMPORT_REPORT_V1_4.json").write_text(
...
print()
print("=" * 120)
print("FILM10 CANONICAL IMPORT V1.4: PASS")
print("=" * 120)
